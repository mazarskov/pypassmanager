...
encrypt_button.place(relx=0.5, rely=0.9, anchor=customtkinter.CENTER)
    

#entry where the key gets generated to
entry2 = customtkinter.CTkEntry(app, placeholder_text="CTkEntry", state='readonly')
entry2.place(relx = 0.1, rely = 0.3, anchor=customtkinter.CENTER)
...
keygen_button.place(relx=0.1, rely=0.2, anchor=customtkinter.CENTER)
...
copy_key_button.place(relx=0.1, rely=0.4, anchor=customtkinter.CENTER)
...
decrypt_button.place(relx=0.7, rely=0.9, anchor=customtkinter.CENTER)    
...
entry_encrypted = customtkinter.CTkEntry(app, placeholder_text="Encrypted text")
entry_encrypted.place(relx = 0.7, rely = 0.2, anchor=customtkinter.CENTER)
